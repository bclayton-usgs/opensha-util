...
public class LocationsTests {
  ...
  //
  // p8 = Location.create(0,-1);
  // p9 = Location.create(1,3);
  //
  ...
  public final void testAngle() {
    assertEquals(1.001818991, Locations.angle(L5, L1), angleD);
    assertEquals(1.005309649, Locations.angle(L2, L5), angleD);
    assertEquals(2.129301687, Locations.angle(L4, L6), angleD);
    assertEquals(2.132792346, Locations.angle(L6, L3), angleD);
    assertEquals(0.006844919, Locations.angle(L1, L2), angleD);
    assertEquals(0.007577932, Locations.angle(L1, L3), angleD);
    assertEquals(0.010879690, Locations.angle(L1, L4), angleD);
    assertEquals(0.009514959, Locations.angle(L2, L3), angleD);
    assertEquals(0.007580467, Locations.angle(L4, L2), angleD);
    assertEquals(0.006867335, Locations.angle(L4, L3), angleD);
  }

  @Test
  public final void testHorzDistance() {
    assertEquals(6382.596, Locations.horzDistance(L5, L1), ldD);
    assertEquals(6404.835, Locations.horzDistance(L2, L5), ldD);
    assertEquals(13565.796, Locations.horzDistance(L4, L6), ldD);
    assertEquals(13588.035, Locations.horzDistance(L6, L3), ldD);
    assertEquals(43.6090311, Locations.horzDistance(L1, L2), sdD);
    assertEquals(48.2790582, Locations.horzDistance(L1, L3), sdD);
    assertEquals(69.3145862, Locations.horzDistance(L1, L4), sdD);
    assertEquals(60.6198752, Locations.horzDistance(L2, L3), sdD);
    assertEquals(48.2952067, Locations.horzDistance(L4, L2), sdD);
    assertEquals(43.7518411, Locations.horzDistance(L4, L3), sdD);
  }
  ...
  public final void testHorzDistanceFast() {
    assertEquals(6474.888, Locations.horzDistanceFast(L5, L1), ldD);
    assertEquals(6493.824, Locations.horzDistanceFast(L2, L5), ldD);
    assertEquals(13707.303, Locations.horzDistanceFast(L4, L6), ldD);
    assertEquals(13735.216, Locations.horzDistanceFast(L6, L3), ldD);
    assertEquals(43.6090864, Locations.horzDistanceFast(L1, L2), sdD);
    assertEquals(48.2790921, Locations.horzDistanceFast(L1, L3), sdD);
    assertEquals(69.3146382, Locations.horzDistanceFast(L1, L4), sdD);
    assertEquals(60.6200022, Locations.horzDistanceFast(L2, L3), sdD);
    assertEquals(48.2952403, Locations.horzDistanceFast(L4, L2), sdD);
    assertEquals(43.7518956, Locations.horzDistanceFast(L4, L3), sdD);

    // test change to allow lon values up to 360
    double original = Locations.horzDistanceFast(P1, P2);
    double updated = Locations.horzDistanceFast(P4, P5);
  ...
  public final void testLinearDistance() {
    ...
    double sd12 = Locations.horzDistance(L1, L2); // 15.256270609
    double ld12 = Locations.linearDistance(L1, L2); // 15.251477684
    double ld13 = Locations.linearDistance(L1, L3); // 21.378955649
  ...
  public final void testLinearDistanceFast() {
    ...
    Location L2 = Location.create(20.1, 20.1, 2);
    Location L3 = Location.create(20.1, 20.1, 17);
    double ld12 = Locations.linearDistanceFast(L1, L2); // 15.256271986
    double ld13 = Locations.linearDistanceFast(L1, L3); // 21.395182516
    assertEquals(15.256271986, ld12, delta);
    assertEquals(21.395182516, ld13, delta);

    // test change to allow lon values up to 360
    double original = Locations.linearDistanceFast(P1, P2);
    double updated = Locations.linearDistanceFast(P4, P5);
    assertEquals(original, updated, sdD);
  }
  ...
  public final void testDistanceToLine() {
    // set 1
    assertEquals(34.425229936, Locations.distanceToLine(L3, L2, L1), dtlD);
    assertEquals(-34.425229936, Locations.distanceToLine(L2, L3, L1), dtlD);
    assertEquals(-47.851004687, Locations.distanceToLine(L4, L3, L2), dtlD);
    assertEquals(30.205855981, Locations.distanceToLine(L4, L1, L3), dtlD);
    // set 2
    assertEquals(0.0, Locations.distanceToLine(l1, l2, p1), 0);
    assertEquals(-111.17811504377568, Locations.distanceToLine(l1, l2, p2), 0);
    assertEquals(-111.04264791008788, Locations.distanceToLine(l1, l2, p3), 0);
    assertEquals(-110.77187883896175, Locations.distanceToLine(l1, l2, p4), 0);
    assertEquals(0.0, Locations.distanceToLine(l1, l2, p5), 0);
    assertEquals(110.7718788389617, Locations.distanceToLine(l1, l2, p6), 0);
    assertEquals(111.04264791008788, Locations.distanceToLine(l1, l2, p7), 0);
    assertEquals(111.17811504377575, Locations.distanceToLine(l1, l2, p8), 0);
  }

  @Test
  public final void testDistanceToLineFast() {
    // set 1
    assertEquals(34.472999888, Locations.distanceToLineFast(L3, L2, L1), dtlD);
    assertEquals(-34.472999888, Locations.distanceToLineFast(L2, L3, L1), dtlD);
    assertEquals(-47.859144611, Locations.distanceToLineFast(L4, L3, L2), dtlD);
    assertEquals(30.170948729, Locations.distanceToLineFast(L4, L1, L3), dtlD);
    // set 2
    assertEquals(0.0, Locations.distanceToLineFast(l1, l2, p1), 0);
    assertEquals(-111.12731528678844, Locations.distanceToLineFast(l1, l2, p2), 0);
    assertEquals(-111.04266335361307, Locations.distanceToLineFast(l1, l2, p3), 0);
    assertEquals(-110.92418674948573, Locations.distanceToLineFast(l1, l2, p4), 0);
    assertEquals(0.0, Locations.distanceToLineFast(l1, l2, p5), 0);
    assertEquals(110.92418674948573, Locations.distanceToLineFast(l1, l2, p6), 0);
    assertEquals(111.04266335361307, Locations.distanceToLineFast(l1, l2, p7), 0);
    assertEquals(111.12731528678844, Locations.distanceToLineFast(l1, l2, p8), 0);

    // test change to allow lon values up to 360
    double original = Locations.distanceToLineFast(P2, P3, P1);
    double updated = Locations.distanceToLineFast(P5, P6, P4);
    assertEquals(original, updated, sdD);
  }
  ...
  public final void testDistanceToSegment() {
    // set 1
    assertEquals(34.425229936, Locations.distanceToSegment(L3, L2, L1), dtlD);
    assertEquals(34.425229936, Locations.distanceToSegment(L2, L3, L1), dtlD);
    assertEquals(47.851004687, Locations.distanceToSegment(L4, L3, L2), dtlD);
    assertEquals(30.205855981, Locations.distanceToSegment(L4, L1, L3), dtlD);
    // set 2
    assertEquals(111.19505230826488, Locations.distanceToSegment(l1, l2, p1), 0);
    assertEquals(157.22560972181338, Locations.distanceToSegment(l1, l2, p2), 0);
    assertEquals(111.04264791008788, Locations.distanceToSegment(l1, l2, p3), 0);
    assertEquals(157.0103400810619, Locations.distanceToSegment(l1, l2, p4), 0);
    assertEquals(111.19505230826486, Locations.distanceToSegment(l1, l2, p5), 0);
    assertEquals(157.0103400810619, Locations.distanceToSegment(l1, l2, p6), 0);
    assertEquals(111.04264791008788, Locations.distanceToSegment(l1, l2, p7), 0);
    assertEquals(157.22560972181338, Locations.distanceToSegment(l1, l2, p8), 0);
  }

  @Test
  public final void testDistanceToSegmentFast() {
    // set 1
    assertEquals(34.472999888, Locations.distanceToSegmentFast(L3, L2, L1), dtlD);
    assertEquals(34.472999888, Locations.distanceToSegmentFast(L2, L3, L1), dtlD);
    assertEquals(47.859144611, Locations.distanceToSegmentFast(L4, L3, L2), dtlD);
    assertEquals(30.170948729, Locations.distanceToSegmentFast(L4, L1, L3), dtlD);
    // set 2
    assertEquals(111.19505230826488, Locations.distanceToSegmentFast(l1, l2, p1), 0);
    assertEquals(157.2056610325692, Locations.distanceToSegmentFast(l1, l2, p2), 0);
    assertEquals(111.04266335361307, Locations.distanceToSegmentFast(l1, l2, p3), 0);
    assertEquals(157.0621369518209, Locations.distanceToSegmentFast(l1, l2, p4), 0);
    assertEquals(111.19505230826486, Locations.distanceToSegmentFast(l1, l2, p5), 0);
    assertEquals(157.0621369518209, Locations.distanceToSegmentFast(l1, l2, p6), 0);
    assertEquals(111.04266335361307, Locations.distanceToSegmentFast(l1, l2, p7), 0);
    assertEquals(157.2056610325692, Locations.distanceToSegmentFast(l1, l2, p8), 0);

    // test change to allow lon values up to 360
    double original = Locations.distanceToSegmentFast(P2, P3, P1);
    double updated = Locations.distanceToSegmentFast(P5, P6, P4);
    assertEquals(original, updated, sdD);
  }

  @Test
  public final void testAzimuth() {
    assertEquals(180.0, Locations.azimuth(L5, L1), azdD);
    assertEquals(0.0, Locations.azimuth(L2, L5), azdD);
    assertEquals(180.0, Locations.azimuth(L4, L6), azdD);
    assertEquals(0.0, Locations.azimuth(L6, L3), azdD);
    assertEquals(239.44623, Locations.azimuth(L1, L2), azdD);
    assertEquals(157.05864, Locations.azimuth(L1, L3), azdD);
    assertEquals(195.78891, Locations.azimuth(L1, L4), azdD);
    assertEquals(111.36156, Locations.azimuth(L2, L3), azdD);
    assertEquals(337.12017, Locations.azimuth(L4, L2), azdD);
    assertEquals(59.34329, Locations.azimuth(L4, L3), azdD);
  }

  @Test
  public final void testAzimuthRad() {
    assertEquals(3.141592654, Locations.azimuthRad(L5, L1), azrD);
    assertEquals(0.0, Locations.azimuthRad(L2, L5), azrD);
    assertEquals(3.141592654, Locations.azimuthRad(L4, L6), azrD);
    assertEquals(0.0, Locations.azimuthRad(L6, L3), azrD);
    assertEquals(4.179125015, Locations.azimuthRad(L1, L2), azrD);
    assertEquals(2.741190313, Locations.azimuthRad(L1, L3), azrD);
    assertEquals(3.417161139, Locations.azimuthRad(L1, L4), azrD);
    assertEquals(1.943625801, Locations.azimuthRad(L2, L3), azrD);
    assertEquals(5.883856933, Locations.azimuthRad(L4, L2), azrD);
    assertEquals(1.035735858, Locations.azimuthRad(L4, L3), azrD);
  }

  @Test
  public final void testLocationLocationDoubleDouble() {
    LocationVector v = LocationVector.create(L1, L2);
    assertTrue(Locations.areSimilar(L2, Locations.location(L1, v.azimuth, v.Δh)));
    v = LocationVector.create(L1, L3);
    assertTrue(Locations.areSimilar(L3, Locations.location(L1, v.azimuth, v.Δh)));
    v = LocationVector.create(L2, L3);
    assertTrue(Locations.areSimilar(L3, Locations.location(L2, v.azimuth, v.Δh)));
  }

  @Test
  public final void testLocationLocationDirection() {
    assertTrue(Locations.areSimilar(L2, Locations.location(L1, LocationVector.create(L1, L2))));
    assertTrue(Locations.areSimilar(L3, Locations.location(L1, LocationVector.create(L1, L3))));
    assertTrue(Locations.areSimilar(L4, Locations.location(L1, LocationVector.create(L1, L4))));
    assertTrue(Locations.areSimilar(L3, Locations.location(L2, LocationVector.create(L2, L3))));
    assertTrue(Locations.areSimilar(L2, Locations.location(L4, LocationVector.create(L4, L2))));
    assertTrue(Locations.areSimilar(L3, Locations.location(L4, LocationVector.create(L4, L3))));
  }

  @Test
  public final void testLocationVector() {
    assertEquals(43.6090311, LocationVector.create(L1, L2).Δh, sdD);
    assertEquals(48.2790582, LocationVector.create(L1, L3).Δh, sdD);
    assertEquals(69.3145862, LocationVector.create(L1, L4).Δh, sdD);
    assertEquals(60.6198752, LocationVector.create(L2, L3).Δh, sdD);
    assertEquals(48.2952067, LocationVector.create(L4, L2).Δh, sdD);
    assertEquals(43.7518411, LocationVector.create(L4, L3).Δh, sdD);

    // TODO these will need to be replaced with azimuthRad()
    assertEquals(239.44623, LocationVector.create(L1, L2).azimuth * TO_DEGREES, azdD);
    assertEquals(157.05864, LocationVector.create(L1, L3).azimuth * TO_DEGREES, azdD);
    assertEquals(195.78891, LocationVector.create(L1, L4).azimuth * TO_DEGREES, azdD);
    assertEquals(111.36156, LocationVector.create(L2, L3).azimuth * TO_DEGREES, azdD);
    assertEquals(337.12017, LocationVector.create(L4, L2).azimuth * TO_DEGREES, azdD);
    assertEquals(59.34329, LocationVector.create(L4, L3).azimuth * TO_DEGREES, azdD);

    assertEquals(0, LocationVector.create(L1, L2).Δv, 0);
    assertEquals(0, LocationVector.create(L1, L3).Δv, 0);
    assertEquals(10, LocationVector.create(L1, L4).Δv, 0);
    assertEquals(0, LocationVector.create(L2, L3).Δv, 0);
    assertEquals(-10, LocationVector.create(L4, L2).Δv, 0);
    assertEquals(-10, LocationVector.create(L4, L3).Δv, 0);

    // reverse tests
    Location L1 = Location.create(20.0, 20.0, 0);
    Location L2 = Location.create(20.1, 20.1, 2);
    LocationVector v = LocationVector.create(L1, L2);
    double az = v.azimuth * TO_DEGREES;
    double dv = v.Δv;
    LocationVector vr = LocationVector.reverseOf(v);
    assertEquals((az + 180) % 360, vr.azimuth * TO_DEGREES, 0);
    assertEquals(-dv, vr.Δv, 0);

    // test plunge
    LocationVector vPlunge = LocationVector.create(0.0, 2, 2);
    assertEquals(45.0, vPlunge.plunge() * TO_DEGREES, 0.0);
  ...
  public final void testBisect() {
    ...
    p2p1 = LocationVector.create(220 * TO_RADIANS, 100, 0);
    p1 = Locations.location(p2, p2p1);
    p2p3 = LocationVector.create(90 * TO_RADIANS, 100, 0);
    p3 = Locations.location(p2, p2p3);
    vTest = Locations.bisect(p1, p2, p3);
    assertEquals(155, vTest.azimuth * TO_DEGREES, tol);

    // 4th quadrant 270-360
    p2p1 = LocationVector.create(320 * TO_RADIANS, 100, 0);
    p1 = Locations.location(p2, p2p1);
    p2p3 = LocationVector.create(20 * TO_RADIANS, 100, 0);
    p3 = Locations.location(p2, p2p3);
    vTest = Locations.bisect(p1, p2, p3);
    assertEquals(170, vTest.azimuth * TO_DEGREES, tol);

    // p1 & p3 coincident
    p2p1 = LocationVector.create(90 * TO_RADIANS, 100, 0);
    p1 = Locations.location(p2, p2p1);
    p2p3 = LocationVector.create(90 * TO_RADIANS, 100, 0);
    p3 = Locations.location(p2, p2p3);
    vTest = Locations.bisect(p1, p2, p3);
    assertEquals(90, vTest.azimuth * TO_DEGREES, tol);

    // p1, p2, & p3 coincident
    vTest = Locations.bisect(p2, p2, p2);
    assertEquals(0, vTest.azimuth * TO_DEGREES, tol);
  }
  ...
  public static void main(String[] args) {
    ...
    Location p2 = L2;
    Location p3 = L3;
    System.out.println(Locations.horzDistance(p1, p2));
    System.out.println(Locations.horzDistanceFast(p1, p2));
    System.out.println(Locations.angle(p1, p2));
    System.out.println(Locations.azimuthRad(p1, p2));
    System.out.println(Locations.azimuth(p1, p2));
    System.out.println(Locations.distanceToLineFast(p1, p2, p3));
    System.out.println(Locations.distanceToLine(p1, p2, p3));
    ...
    for (int i = 0; i < 5; i++) {
      ...
      for (int j = 0; j < numIter; j++) {
        d = (fixedVals) ? Locations.distanceToLine(L1, L2, L3)
            : Locations.distanceToLine(randomLoc(), randomLoc(), randomLoc());
      }
      T = (System.currentTimeMillis() - T);
      System.out.println("    DTL: " + T);
    }

    System.out.println("distToLineFastOLD(): " + distanceToLineFastOLD(L1, L2, L3));
    for (int i = 0; i < 5; i++) {
      long T = System.currentTimeMillis();
      double d;
      for (int j = 0; j < numIter; j++) {
    ...
    System.out.println("distanceToLineFast(): " + Locations.distanceToLineFast(L1, L2, L3));
    for (int i = 0; i < 5; i++) {
      long T = System.currentTimeMillis();
      double d;
      for (int j = 0; j < numIter; j++) {
        d = (fixedVals) ? Locations.distanceToLineFast(L1, L2, L3)
            : Locations.distanceToLineFast(randomLoc(), randomLoc(), randomLoc());
      }
      T = (System.currentTimeMillis() - T);
      System.out.println("   DTLF: " + T);
    }

    System.out.println("distanceToSegment(): " + Locations.distanceToSegment(L1, L2, L3));
    for (int i = 0; i < 5; i++) {
      long T = System.currentTimeMillis();
      double d;
      for (int j = 0; j < numIter; j++) {
        d = (fixedVals) ? Locations.distanceToSegment(L1, L2, L3)
            : Locations.distanceToSegment(randomLoc(), randomLoc(), randomLoc());
      }
      T = (System.currentTimeMillis() - T);
      System.out.println("    DTS: " + T);
    }

    System.out.println("distanceToSegmentFast(): " + Locations.distanceToSegmentFast(L1, L2, L3));
    for (int i = 0; i < 5; i++) {
      long T = System.currentTimeMillis();
      double d;
      for (int j = 0; j < numIter; j++) {
        d = (fixedVals) ? Locations.distanceToSegmentFast(L1, L2, L3)
            : Locations.distanceToSegmentFast(randomLoc(), randomLoc(), randomLoc());
      }
      T = (System.currentTimeMillis() - T);
    ...
    // // L1 = new Location(-10, 20);
    // // L2 = new Location(60, -20);
    //
    // // mid pair ~250 km : discrepancies in 10s of meters
    // // L1 = new Location(-117.2, 32.1);
    // // L2 = new Location(-115.4, 33.8);
    //
    // // short pair : negligible discrepancy in values
    // L1 = new Location(-117.21, 32.132);
    // L2 = new Location(-117.105, 32.306);
    //
    ...
    // // ==========================================================
    //
    // L1 = new Location(-117, 32);
    // L2 = new Location(-115, 33);
    //
    // System.out.println("\nSPEED TEST -- Azimuth\n");
    ...
    //
    // Location L1a = new Location(-10, 20); // 8818.496 km
    // Location L1b = new Location(60, -20);
    //
    // Location L2a = new Location(10, 90); // 4461.118 km
    // Location L2b = new Location(80, 50);
    //
    // Location L3a = new Location(-30, -80); // 3824.063 km
    // Location L3b = new Location(20, -50);
    //
    // Location L4a = new Location(178, -42); // 560.148 km
    // Location L4b = new Location(-178, -38);
    //
    // Location L5a = new Location(-90, 5); // 784.028 km
    // Location L5b = new Location(-85, 0);
    //
    // Location L6a = new Location(-40, 70); // 1148.942 km
    // Location L6b = new Location(-50, 80);
    //
    // Location L7a = new Location(80, -30); // 1497.148 km
    // Location L7b = new Location(90, -20);
    //
    // Location L8a = new Location(70, 70); // 234.662 km
    // Location L8b = new Location(72, 72);
    //
    // Location L9a = new Location(120, -20); // 305.532 km
    // Location L9b = new Location(122, -18);
    //
  ...
  // calculators
  private static LocationList createLocList(Location L1, Location L2, double lonInterval) {
    int numPoints = (int) Math.floor(Math.abs(L2.longitude - L1.longitude) / lonInterval);
    double dLat = (L2.latitude - L1.latitude) / numPoints;
    double dLon = (L1.longitude - L2.longitude < 0) ? lonInterval : -lonInterval;
  ...
  private static double getAzimuthOLD(Location loc1, Location loc2) {
    return getAzimuthOLD(loc1.latitude, loc1.longitude,
        loc2.latitude, loc2.longitude);
  }
  ...
  private static double getTotalDistanceOLD(Location loc1, Location loc2) {
    ...
    double vDist = Locations.vertDistance(loc1, loc2);
  ...
  private static Location getLocationOLD(
    ...
    double azimuth = direction.azimuth * TO_DEGREES;
    double horzDistance = direction.Δh;
    double vertDistance = direction.Δv;
